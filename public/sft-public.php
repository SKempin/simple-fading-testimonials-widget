 ...
 * @subpackage simple-fading-testimonials-widget/public
 */
...
class Simple_Fading_Testimonials_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/sft-public.min.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/sft-public.min.js', array( 'jquery' ), $this->version, false );
